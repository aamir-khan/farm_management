...
class Field(TimeStampedModel):
    ...
    lease_per_acre = models.FloatField(
        verbose_name=_('Lease per acre'), help_text=_('If leased then theka in thousands'), blank=True)
    lease_start = models.DateField(
        blank=True, verbose_name=_('Lease start'), help_text=_('Lease start date if not owned'))
    lease_end = models.DateField(
        blank=True, verbose_name=_('Lease end'), help_text=_('Lease end date if not owned')
    )
